...
<div id="main-text" style="z-index: 10000;">
    ...
    <br>
    <strong>New in 5.0.2:</strong>
    <br>
    <strong>custompp (block) - autopp but with custom block</strong>
    <br>
    <strong>superpp - autopp but big</strong>
    <br>
    <strong>supercustompp (block) - superpp but with custom block</strong>
    <br>
    <strong>ppexplode - a tnt pp that detonates itself</strong>
    <br>
    <strong>ppnuker - mines blocks the shape of a pp</strong>
    <br>
    <strong>ppnukeroff - turns off ppnuker</strong>
    <br>
    <strong>xray - a somewhat laggy but working xray (not recommended for mobile; use by walking)</strong>
    <br>
    <strong>laggyxray - a very laggy but even better xray (not recommended for mobile; use by walking)</strong>
    <br>
    <strong>xrayoff - turns off xray</strong>
    <br>
    <strong>laggyxrayoff - turns off laggyxray</strong>
    <br>
    <strong>anti-lagc - removes unnecessary lag but keeps you on creative mode</strong>
    <br>
    <strong>anti-lags - removes unnecessary lag but keeps you on survival mode</strong>
    <br>
</div>
